                                ...
                                >
                                    <div className="flex justify-between items-start mb-2">
                                        ...
                                        <div className="flex gap-1 items-center">
                                            ...
                                            <PriorityBadge level={report.priorityLevel} size="sm" />
                                            <EscalationBadge isDelayed={report.isDelayed} isCritical={report.isCritical} size="sm" />
                                        </div>
                                    </div>
                            ...
                            <div className="card-elevated p-6 sticky top-24 space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2 flex-wrap">
                                        {(['inProgress', 'resolved', 'completed'] as const).map(s => (
                                            <Button
                                                key={s}
                                                size="sm"
                                            ...
                                            >
                                                {s === 'inProgress' ? 'In Progress' : s === 'resolved' ? 'Resolved' : 'Completed'}
                                            </Button>
                                        ))}
                                    </div>
                                </div>
