...
import { formatResolutionTime } from '@/lib/automation';
                ...
                <div className="space-y-6">
                  ...
                  <div className="card-elevated p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t border-border">
                      ...
                      {report.supportCount != null && report.supportCount > 0 && (
                        <span className="status-badge bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400">
                          👥 {report.supportCount} {t.supportCount || 'supporters'}
                        </span>
                      )}
                      {report.resolutionTimeHours != null && (
                        <span className="status-badge bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400">
                          ✅ {t.resolutionTime || 'Resolution'}: {formatResolutionTime(report.resolutionTimeHours)}
                        </span>
                      )}
                    </div>
                  </div>
